...
\subsection{Making SLO Predictions}
\label{sec:qbets}
...
More succinctly, QBETS sorts observations in a history of observations,
...
Cerebro also periodically recomputes the SLOs for the APIs over time. 
...
%Cerebro can suspend API access by affected API consumers until 
...
%SLO changes as SLO reassessments. 
