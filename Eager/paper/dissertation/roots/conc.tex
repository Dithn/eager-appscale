Uncovering performance bottlenecks in a timely manner,
and resolving them urgently is a key requirement for implementing governance in cloud
environments. Application developers and cloud administrators
...
PaaS clouds, where the application runtime details are hidden beneath a layer of kernel services.
The existing cloud monitoring solutions do not have the necessary penetrative power
to monitor all the different layers of cloud platforms, and consequently, their diagnosis
capabilities are severely limited.

We present Roots, a near real time monitoring framework for applications deployed in a PaaS cloud. 
