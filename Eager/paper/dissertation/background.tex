...
Cloud-hosted applications expose one or more web application programming 
...
PaaS clouds facilitate deploying and running applications
...
On top of the infrastructure layer lies the PaaS kernel -- a collection of managed, scalable
...
One level above the PaaS kernel reside the application servers that are used to deploy and run
...
The application developer uses the kernel services via the SDK to implement his/her application logic, and packages 
...
When the software engineering community started gravitating towards web services and
...
Services required new forms of governance for managing their performance
...
None of the above features are implemented satisfactorily in the cloud technologies available today.
...
We design governance systems targeting the APIs exposed by the cloud-hosted
