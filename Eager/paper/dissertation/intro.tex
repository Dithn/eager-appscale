...
performance of the deployed applications, and establishing service level objectives (SLOs) 
regarding their performance.} A performance SLO in this context specifies a bound on application's
...
reason, it is also not possible to stipulate SLOs on the performance of cloud-hosted applications. 
