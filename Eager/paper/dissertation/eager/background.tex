For all practical intents and purposes, web 
applications deployed in the cloud are a form of web services. 
Therefore we often refer to them simply as \textit{services} in the remainder of this chapter. 
We use the term \textit{client application} to refer to an application that consumes
a cloud-hosted application by making remote API calls.
