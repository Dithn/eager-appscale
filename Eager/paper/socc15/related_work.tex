...
%Program slicing helps to reduce the amount of code and program states that need to be 
 %analyzed by SWEET. 
Program slicing used in this prior work to limit the amount of code being analized is similar in its goal as our focus on cloud SDK invocations.
...
Cerebro's notion of prediction validity period has some relation to this line of research. However,
