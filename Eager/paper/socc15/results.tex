...
time series by treating it as a distribution. 
We keep rest of Cerebro unchanged, and swap QBETS out for the simple predictor. Then we make
$95^{th}$ percentile
...
generates predictions while consistently maintaining its accuracy level above 95\%.
