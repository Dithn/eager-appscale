...
%%can greatly reduce the amount of code they must write. 
...
We refer to the process of diagnosing whether increased workload or
...
%For a given anomaly, the root cause could be a change in the application
%workload or a \textit{bottleneck} in the application runtime.  Bottlenecks
%may occur in the application code, or in the PaaS services that the
%application rely on.
