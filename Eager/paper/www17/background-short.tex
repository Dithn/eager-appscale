...
%execution of multiple instances of the application. 
...
\begin{figure}
\centering
\includegraphics[scale=0.3]{paas_architecture}
...
%How this infrastructure is set up may vary from a simple cluster of physical 
...
%the intrinsic services. 
%All deployment and utility services are provisioned 
