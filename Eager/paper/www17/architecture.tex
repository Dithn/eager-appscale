...
data from all layers in the PaaS stack (i.e. full stack monitoring). Figure also indicates tagging incoming
requests with unique identifiers, and reporting events along with the identifiers of the requests they are
associated with.
