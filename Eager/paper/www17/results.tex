...
faults (temporary spikes in application latency), when some of the injected faults
were still in the sliding window of the anomaly detector. Together these two types of
faults caused an SLO violation, usually several minutes after the fault injection period
has expired.
