We next evaluate the efficacy of Roots in bottleneck identification for performance anomalies 
...
We first experiment with the Roots
SLO-based, anomaly detector using a simple HTML-producing, Java App Engine
...
Finally, we evaluate the performance overhead incurred by Roots on the applications deployed in the 
