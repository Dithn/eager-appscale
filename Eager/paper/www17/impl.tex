\textcolor{green}{To investigate the efficacy of Roots as an approach to
...
%implemented a Roots prototype for the 
AppScale
...
%By doing so a lot of the heavy 
...
%We implement a performance SLO checker as the primary anomaly detector in Roots. 
...
\textcolor{green}{We have implemented a path distribution analyzer and anomaly
detector in Roots.
...
%which of the above two causes may be behind it.
...
%Now we describe our algorithm for identifying performance bottlenecks. It 
...
Roots bottleneck identification mechanism \textcolor{green}{first ranks and
...
%them to the linear regression model
...
%historical trend of relative importance 
