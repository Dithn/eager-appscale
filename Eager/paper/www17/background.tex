...
one or more performance SLOs to be violated. Our approach associates each application with
...
point that at least one of its SLOs get violated, we treat it as an anomaly. Moreover, the process
of diagnosing the reason for an anomaly is referred to as \textit{root cause analysis}.
