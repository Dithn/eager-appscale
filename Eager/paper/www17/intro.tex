...
which significantly increases the effort and financial cost of maintaining an application.
Developers must also ensure
that their instrumentation is correct, and does not degrade 
application performance.  Further, because the applications depend on extant
cloud services (e.g. scalable database services, network load balancing,
