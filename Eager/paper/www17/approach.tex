...
programmer or third-party tool, it must infer application performance from 
the performance of the PaaS services in the platform. 
...
operations). A layer cannot monitor state changes
...
to attribute invocations of PaaS service operations with a particular request (and thus application).
...
facilitates tracing the execution of application requests 
