...
Roots modifies the front-end request server (typically asoftware load
balancer) 
...
Figure~\ref{fig:apm_architecture} also shows Roots collecting data from all
layers in a 
...
Collecting this 
information
%PaaS kernel invocation details 
