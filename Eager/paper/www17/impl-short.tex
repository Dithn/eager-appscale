...
To use it, Roots regresses the latencies from a set of calls to
the PaaS services that a specific request generates against the total 
...
recently (i.e. within the analysis window) large latencies. 
