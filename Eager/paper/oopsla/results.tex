...
consider the 5th percentiles of the distributions, these values are also above 1 hour. The smallest 5th percentile value of 1.41 hours is 
shown by the ServerHealth\#info operation. This indicates that if we use 3 consecutive violations as a cue for detecting SLA
invalidation events, Cerebro predictions made on Google App Engine would be valid for 1.4 hours or more, at least 95\% of the time.
In other words, Cerebro predictions on Google App Engine are good for 1.4 hours or more, a large majority of the time.