...
\begin{figure}
\centering
\includegraphics[scale=0.35]{as_mean_diff}
...
exhibit average differences less than 45ms. A closer look at the corresponding standard deviations of actual response times reveal that APIs deployed 
...
to generate less conservative, or in other words more tight bounds with higher accuracy. 
