...
We report that the average time taken by Cerebro to analyze and make predictions for the above
...
and the time taken by QBETS to make predictions. Length of the time series stored in cloud SDK
monitor was 1528 during these initial tests (25.5 hours of monitoring data). Since the QBETS
analysis time depends on the length of the input time series, we also conducted a test where
we ran Cerebro on StudentInfo with 19322 data points in the cloud SDK
monitor (nearly 2 weeks of monitoring data). Even in this case, Cerebro took only 574.05 seconds 
(9.6 minutes).
