...
This is not the case when running our sample applications on Google App Engine, where we have no control over 
...
Figure~\ref{fig:gae_accuracy} shows the percentage accuracy of the Cerebro predictions made in Google App Engine 
...
These results are very similar to the ones seen in Google App Engine, except for a somewhat faster convergence. In AppScale
...
Google App Engine), before it can start producing stable and highly accurate SLA predictions. Therefore, it is a good idea to start Watchtower in the
...
Cerebro predictions made on Google App Engine would be valid for 1.41 hours or more, at least 95\% of the time.
...
characteristics in Google App Engine. This fact is reflected in the 5th percentiles of StudentInfo\#getStudent and
