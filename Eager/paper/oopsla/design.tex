In this section we describe the design of Cerebro, our system for estimating web API execution times
...
The basic idea behind Cerebro's static analysis is to construct and walk the
 control flow graph (CFG)~\cite{Allen:1970:CFA:800028.808479} of the given code. Whenever the algorithm encounters a node that represents a function call,
...
Constructing the CFG from a given program is a commonly occurring requirement
