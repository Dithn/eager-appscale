Web services, service oriented architectures, and cloud platforms have together
...
Cerebro generates response-time SLAs for API calls exported by a web-facing
application
