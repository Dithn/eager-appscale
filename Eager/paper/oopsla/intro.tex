...
Using the web service model, developers create new web services and applications
...
fulfilled by each web API operation exported by applications
hosted in the PaaS.  
...
Cerebro generates response time SLAs for API calls exported by a web-accessible
application
