...
and network operations, most third party library calls, and intrinsics that allow
...
arbitrary complexity and logic with ease. An example policy file written using EAGER
policy language is shown below. This policy mandates that any application or mashup
...
Finally, we present an example that mandates all POST operations exposed by APIs must be
