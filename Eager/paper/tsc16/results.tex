...
Generally, in all our experiments Roots detected anomalies within 2 to 5 minutes of the start of the
fault injection, if the detector was active when the fault injection started. The longest time to anomaly
detection we observed was 4 minutes 50 seconds. Note that this is due to the analysis and sampling rate
parameters we have employed in our tests. We believe that most developers would appreciate
a reaction time in the order of few minutes. If an even faster reaction time is desired, Roots enables configuring
detectors with faster analysis and sampling rates.
