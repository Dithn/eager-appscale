...
%Arrows indicate the flow of data and control in response to application requests.
...
%In order to perform comprehensive monitoring
...
PaaS-hosted web applications rely on the PaaS kernel services offered by the underlying
