...
However, it has been engineered so that it can run on
``bare metal'' machines, or in an Infrastructure-as-a-Service cloud like Amazon EC2.

Due to AppScale's
API compatibility with GAE, any application developed for GAE can be deployed
on AppScale with no code changes. Since AppScale is open source
