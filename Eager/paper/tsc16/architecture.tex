...
layers. 
%For example, an application request gets routed through the front-end server before
...
To facilitate these requirements, we augment the front-end server of the cloud platform. 
...
%Additionally we may also collect information pertaining to active
...
the cloud platform. 
%Failures in detectors and handlers have no impact
