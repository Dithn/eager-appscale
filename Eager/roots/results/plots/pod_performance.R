...
par(mai=c(1,1,0.7,1))
bars <- barplot(t(as.matrix(cbind(data[,'Memory'], data[,'CPU']*7))), beside=T, ylim=c(0,700), col=c('red','blue'), names.arg=c(100, 1000, 10000), xlab='Number of Detectors', ylab='Average Memory Usage (MB)')
